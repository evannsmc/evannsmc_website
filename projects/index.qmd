          ...
          <summary>
            <div class="project-summary">
              ...
              <div class="project-preview-panel clip-preview">
                <video src="../projects/nmpc-acados/nmpc_loop.mp4"
                       autoplay muted loop playsinline preload="metadata"
                       aria-label="NMPC-controlled quadrotor tracking a horizontal circle in Georgia Tech's Indoor Flight Lab"></video>
              </div>
            </div>
          </summary>
          <div class="project-body">
