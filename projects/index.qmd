...
/* Keep preview media at thumbnail scale. Full-bleed footage reads as a hero
   image and overwhelms the card copy. Applied to the rtd gif as well so the
   top row of both columns stays visually matched. */
.project-preview-panel.rtd-preview,
.project-preview-panel.clip-preview {
  max-width: 66%;
  margin-inline: auto;
          ...
          <summary>
            <div class="project-summary">
              ...
              <div class="project-preview-panel clip-preview">
                <video src="../projects/nr-flow/nr_loop.mp4"
                       autoplay muted loop playsinline preload="metadata"
                       aria-label="Newton-Raphson Flow controller flying a quadrotor helix in Georgia Tech's Indoor Flight Lab"></video>
              </div>
            </div>
          </summary>
          <div class="project-body">
            ...
            <div class="project-summary">
              ...
              <div class="project-preview-panel clip-preview">
                <video src="../projects/mocap4px4/mocap_loop.mp4"
                       autoplay muted loop playsinline preload="metadata"
                       aria-label="Overhead motion-capture view of a quadrotor flying inside the tracked volume"></video>
              </div>
            </div>
          </summary>
          <div class="project-body">
