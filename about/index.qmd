...
<div class="about-shell">
  ...
  <div class="about-bio">
    <p>
      Armed with my Bachelor's degree in Electrical Engineering and a certificate in unmanned vehicle systems, I decided to make the jump from the DFW to Atlanta to pursue my Ph.D. in Robotics. Rather than getting a Master's, I am instead the proud owner of 2 undergraduate minor degrees and 1 doctoral minor degree.
    </p>
  </div>
  ...
  <section class="about-hobbies-panel">
    ...
    <div class="about-hobbies-grid">
      <article class="about-hobby-card">
        ...
        <p>Trying to get a running streak going on Strava.</p>
      </article>
      <article class="about-hobby-card">
        <p class="about-hobby-card-title">Cooking</p>
        <p>If you get invited to my cooking nights, you know you're cool.</p>
      </article>
      <article class="about-hobby-card">
        <p class="about-hobby-card-title">Dance</p>
        <p>I promise I'm getting better.</p>
      </article>
      <article class="about-hobby-card">
