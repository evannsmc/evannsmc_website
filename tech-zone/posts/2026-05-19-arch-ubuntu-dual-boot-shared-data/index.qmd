...
ln -sf /usr/share/zoneinfo/America/Chicago /etc/localtime && echo "ubuntu" > /etc/hostname

# the UID-1000 user — same NAME and UID as Arch, for /data ownership parity
groupadd -g 1000 user; useradd -m -u 1000 -g 1000 -s /bin/bash -G sudo,adm,cdrom,dip,plugdev user
passwd user
