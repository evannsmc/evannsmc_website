...
cryptsetup status crypt_arch      # active LUKS2 mapping (Arch root)
cryptsetup status crypt_shared    # active LUKS2 mapping (shared data)
```
...
cryptsetup status crypt_shared
...
cryptsetup status crypt_arch     # active LUKS2
cryptsetup status crypt_shared   # active LUKS2
