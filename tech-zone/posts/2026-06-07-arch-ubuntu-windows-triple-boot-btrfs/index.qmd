...
Don't `swapon` from inside the chroot (it blocks clean unmounting). zram (priority 100) carries everyday swap; the swap file (priority -2) is for hibernation. Rationale: [the NoCOW hibernation swap file →](../2026-06-07-arch-ubuntu-dual-boot-btrfs/#chapter-8-hibernation-swap-file-for-arch) and [two-tier zram swap →](../2026-06-07-arch-ubuntu-dual-boot-btrfs/#chapter-9-zram-for-everyday-compressed-swap).
