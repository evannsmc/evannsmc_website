...
cryptsetup status crypt_arch      # active LUKS2 (Arch root)
cryptsetup status crypt_shared    # active LUKS2 (shared data)
```
...
cryptsetup status crypt_shared       # active LUKS2 (same shared UUID from both)
